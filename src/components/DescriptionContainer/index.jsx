...
export const DescriptionContainer = () => {
    ...
    return (
        <div className={`col-6 heightFitContent bg-white p-2 rounded shadow-sm ${style.descriptionContainer}`}>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href={data.competitiveProgramming.hackerrank} target='_blank'>HackerRank</a>, <a href={data.competitiveProgramming.codeforces} target='_blank'>CodeForces</a>
                        </td>
                    </tr>
                </tbody>
            </table>
