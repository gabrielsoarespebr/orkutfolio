            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href={data.competitiveProgramming.codeforces} target='_blank'>CodeForces</a>, <a href={data.competitiveProgramming.codesignal} target='_blank'>CodeSignal</a>, <a href={data.competitiveProgramming.codewars} target='_blank'>CodeWars</a>, <a href={data.competitiveProgramming.hackerrank} target='_blank'>HackerRank</a>, <a href={data.competitiveProgramming.beecrowd} target='_blank'>BeeCrowd</a>
                        </td>
                    </tr>
                </tbody>
            </table>
