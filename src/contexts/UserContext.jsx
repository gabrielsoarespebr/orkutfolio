...
export const UserProvider = ({ children }) => {
  const data = {
    ...
    description:
      "Desenvolvedor autêntico e objetivo, capaz de se comunicar em equipe de forma eficiente, visando proporcionar a melhor experiência ao usuário através de interfaces atraentes, funcionais e responsivas",
    skills: [
      {
        title: "Angular",
    ...
    certifications: [
      ...
      {
        title:
          "Inglês Comercial: Como Escrever E-mails Empresariais Bem-Sucedidos",
        organization: "LinkedIn",
        tags: ["eng", "comm"],
      },
      {
        title:
          "Inglês Comercial: Como Impressionar em Entrevistas de Emprego On-line",
        organization: "LinkedIn",
        tags: ["eng", "comm"],
      },
      {
      ...
      {
        title:
          "Estudo descritivo das interjeições da Libras e A diferença de tradução e transcrição signwriting da literatura surda",
        organization: "Universidade Federal de Campina Grande",
      ...
      {
        title:
          "Trilha Conectar - Fundamentos da programação, software, hardware, internet e servidores",
      ...
      {
        title:
          "A lexicografia da Libras na educação dos surdos e A atuação do TILS em debates políticos e campanhas eleitorais",
        organization: "Universidade Federal de Campina Grande",
        tags: ["signlang", "access", "edu", "comm"],
      },
      {
        title:
          "Educação de surdos no Brasil e Produções culturais do povo surdo",
        organization: "Universidade Federal de Campina Grande",
        tags: ["signlang", "access", "edu", "comm"],
      },
      {
      ...
      {
        title:
          "Reflexões sobre a escrita acadêmica dos estudantes surdos e Antropomorfismo em Libras",
        organization: "Universidade Federal de Campina Grande",
        tags: ["signlang", "access", "edu", "comm"],
      },
      {
        title:
          "Tipologia linguística da Libras e Interpretação de descrições imagéticas",
        organization: "Universidade Federal de Campina Grande",
        tags: ["signlang", "access", "comm"],
      },
      {
      ...
      {
        title:
          "Responsabilidade Civil dos Médicos, Planos de Saúde e Hospitais",
        organization: "OAB SP",
        tags: ["jur"],
      },
      {
        ...
        organization:
          "ETEPAM - Escola Técnica Estadual Professor Agamenon Magalhães",
        tags: ["signlang", "access", "comm"],
      },
      {
